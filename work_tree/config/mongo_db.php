...
global $DB_MONGO_HOST,$DB_MONGO_PORT,$DB_MONGO_USER,$DB_MONGO_PASSWORD,$MONGO_DATABASE;

$config['mongo_db']['active'] = 'default';

$config['mongo_db']['default']['no_auth'] = true;
$config['mongo_db']['default']['hostname'] = $DB_MONGO_HOST;
$config['mongo_db']['default']['port'] = $DB_MONGO_PORT;
$config['mongo_db']['default']['username'] = $DB_MONGO_USER;
$config['mongo_db']['default']['password'] = $DB_MONGO_PASSWORD;
